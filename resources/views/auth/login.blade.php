                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block">
                            <img src="{{ asset('assets/images/auth/login_1.jpg')}}" height="400" width="500">
                        </div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form action="{{ route('autenticar') }}" method="post" class="user">
                                    @csrf
                                ...
                                <div class="text-center">
                                    ...
                                    <a class="small" href="{{ route('home') }}">{{ __('Volver!') }}</a>
                                </div>
                                @endif
                            </div>
                        </div>
